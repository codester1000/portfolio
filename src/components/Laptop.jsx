...
function Model({ open, hinge, ...props }) {
  ...
  return (
    <group ref={group} scale={1.25} {...props} onPointerOver={(e) => (e.stopPropagation(), setHovered(true))} onPointerOut={(e) => setHovered(false)} dispose={null}>
...
export default function Laptop() {
  ...
  return (
    <div style={{ background: props.open.to([0, 1], ['#f0f0f0', '#d25578']), height: "600px", width: "600px" }}>
